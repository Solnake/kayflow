<%@ Control Language="C#" AutoEventWireup="true" CodeFile="StateEdit.ascx.cs" Inherits="Controls_AdminControls_StateEdit" %>
<dx:ASPxFormLayout ID="frmEditForm" runat="server" AlignItemCaptionsInAllGroups="True" Width="100%">
    <Items>
        <dx:LayoutItem Caption="Статус" FieldName="Name">
                ...
                <dx:LayoutItemNestedControlContainer runat="server" SupportsDisabledAttribute="True">
                    <dx:ASPxTextBox ID="txtName" runat="server" SkinID="Required" MaxLength="256">
                        <ValidationSettings ValidationGroup="vgSave">
                            <RequiredField ErrorText="Вкажіть назву статусу" />
                        </ValidationSettings>
                    </dx:ASPxTextBox>
