<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CategoryList.ascx.cs" Inherits="Controls_AdminControls_CategoryList" %>
...
<dx:ASPxGridView ID="gridList" runat="server" Width="100%" ClientInstanceName="gridList"
    ...
    <Columns>
        <dx:GridViewDataTextColumn FieldName="Name" Caption="Категорія" />
